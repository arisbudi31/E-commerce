        ...
        <div class="col-md-10 mx-auto">
            <div class="card">
                <div class="card-header">
                    <span>Pengguna</span>
                    <a href="<?= base_url('user/create') ?>" class="btn btn-sm btn-secondary btn-warning">Tambah
                        Pengguna</a>
                    <div class="float-right">
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                ...
                                <a href="<?= base_url('user/reset') ?>" class="btn btn-sm btn-secondary btn-info"><i
                            ...
                            <tr>
                                ...
                                <td>
                                    <p>
                                        ...
                                        base_url("images/user/ktpku.jpg") ?>" alt="" height="50">
                                        <?= $row->name ?>
                                    </p>
                                </td>
                                <td><?= $row->email ?></td>
