            ...
            <div class="row mb-3">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p>Tanggal pemesanan: <?= str_replace('-', '/', date("d-m-Y", strtotime($order->date))) ?>
                            </p>
                            <p>Nama: <?= $order->name ?></p>
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p>Rekening a/n: <?= $order_confirm->account_name ?></p>
                            <p>No. Rek: <?= $order_confirm->account_number ?></p>
                            <p>Jumlah transfer: Rp<?= number_format($order_confirm->nominal, 0, ',', '.') ?>,-</p>
